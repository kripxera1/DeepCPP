...
masks.first_block_lambda = @(mat) kron([1 0;0 0], mat);
masks.second_block_lambda = @(mat) fliplr(first_block_lambda(mat));
masks.third_block_lambda = @(mat) flipud(first_block_lambda(mat));
masks.fourth_block_lambda = @(mat) flipud(second_block_lambda(mat));
